...
export const de = {
  ...
  mobile: {
    journal: {
      rating: '{{label}} {{value}}/5',
      views: 'Tagebuchansichten',
      entries: 'Tageseinträge',
      periods: 'Perioden',
      allDays: 'Alle Tage',
      empty:
    ...
    checkIn: {
      title: 'Heutigen Eintrag hinzufügen',
      editTitle: 'Heutigen Eintrag bearbeiten',
