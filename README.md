...
> **Development preview — version 0.7.0.** The app is not a medical device, contraceptive tool, ovulation test, pregnancy test, or substitute for professional medical advice.
